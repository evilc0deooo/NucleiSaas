...
from common.redis_queue import NucleiRedisQueue, ZombieRedisQueue
from common.mongo import conn_db, get_project_yaml, get_project_zombie, update_node_info
    ...
    while True:
        ...
        if len(nuclei_collection_data) != 0:
            ...
            for nuclei_queue_name in nuclei_collection_data:
                ...
                nuclei_project_data = get_project_yaml(nuclei_queue_name)
                ...
                NucleiScan(nuclei_queue_name, sites, nuclei_template_yaml, nuclei_template_tags, nuclei_severity, nuclei_proxy)
            ...
            for zombie_queue_name in zombie_collection_data:
                ...
                zombie_project_data = get_project_zombie(zombie_queue_name)
